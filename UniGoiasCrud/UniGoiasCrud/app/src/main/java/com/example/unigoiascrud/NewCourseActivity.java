...
public class NewCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseBtn = findViewById(R.id.idBtnSalvarCurso);
        ...
        courseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (courseName.isEmpty() || courseDesc.isEmpty() || courseDuration.isEmpty()) {
                    Toast.makeText(NewCourseActivity.this, "Preencha todas as informações sobre o curso.", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void saveCourse(String courseName, String courseDescription, String courseDuration) {
        ...
        Toast.makeText(this, "Curso salvo com sucesso no banco de dados Room. ", Toast.LENGTH_SHORT).show();
    }
}
